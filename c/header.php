...
<head>
	...
	<style>
		*{margin:0px; padding:0px; font-family:Gotham, "Helvetica Neue", Helvetica, Arial, sans-serif;}
		...
		#menu a{line-height:2em; font-size:24px; text-decoration:none; color: #000; font-weight:bold}
		h1 {font-family: Helvetica, Arial, sans-serif;  text-align: center;text-shadow: 2px 2px 0px rgba(255,255,255,.7), 5px 7px 0px rgba(0, 0, 0, 0.1);  font-size:60px; color:#000; line-height:8em;}
